...
// BankingAccount object but include new behavior of remembering the minimum and
// maximum balances ever recorded for the account. You should provide the same
// methods as the superclass, as well as the following new behavior
